...
public class SchoolFootballClubU18 extends FootballClub implements Serializable {
	private final int MAX_AGE = 17;
	
	public SchoolFootballClubU18(String name, String location) {
		super(name, location);
	}
